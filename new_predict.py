...
# ======= AUDIO PATH =======
test_audio_path = r"C:\Users\user\Downloads\XC979252 - Andean Guan - Penelope montagnii.mp3"
...
# ======= EXTRACT & PREDICT WITH PROBABILITIES =======
...
if features is not None:
    ...
    top_5_species = label_encoder.inverse_transform(top_5_idx)
    top_5_probs = proba[top_5_idx]

    # ======= Print Top-1 =======
    top_species = top_5_species[0]
    top_prob = top_5_probs[0]
    print(f"\n🔊 Most Likely Bird Species: {top_species} ({top_prob:.4f})")
